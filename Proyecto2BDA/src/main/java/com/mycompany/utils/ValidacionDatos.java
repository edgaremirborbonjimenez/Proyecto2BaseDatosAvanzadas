...
public class ValidacionDatos {
     ...
     * @return Regresa verdadero si el texto esta vacio o en blanco,
     * regresa falso si no esta vacio o en blanco.
     */
    ...
    /**
     * Metodo utilizado para validar si una cadena excede el limite de caracteres
     * especificados.
     * @param texto Texto a validar
     * @param limiteCaracteres Cantidad de caracteres maximos
     * @return Regresa verdaero si el texto esta vacio o excede el limite
     * de caracteres especificado, regresa falso si no esta vacio o excede 
     ...
     * @param texto Texto a validar
     * @return Regresa verdadero si la cadena a validar tiene algun caracter
     * no aceptado, regresa falso si no tiene ningun otro caracter no aceptado.
     */
